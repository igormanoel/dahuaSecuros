...
def connect(deviceIp):
    ...
    authB = requests.auth.HTTPBasicAuth(devices['devices'][deviceIndex]['user'], settings['12345'])
    authD = requests.auth.HTTPDigestAuth(devices['devices'][deviceIndex]['user'], settings['12345'])
